#ifndef GAME_OF_LIFE_EXO_6
#define GAME_OF_LIFE_EXO_6
...
namespace Exercice6
{
	// Exercice 6 : Collective operation when summing the result -- 1/2 proc only
	...
	std::string solve(int argc, char* argv[])
	{
		...
		else
		{
			...
			returnMessage = "Proc #" + std::to_string(procID) + " Total Sum = " + std::to_string(totalSum);
		}
